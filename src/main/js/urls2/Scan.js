...
import { Form, Button, Spinner, Container, Image, Collapse } from "react-bootstrap";
...
const Scan = () => {
    ...
    const [targetURL, setTargetURL] = useState("https://tnbonline.ps/Retail/servletcontroller");
      ...
      <div>
         {status == "p" ? 
          <div className='spinner-div'>
              <Spinner animation="border" variant="dark" className="div-spinner" role="status">
              </Spinner>
          </div> : ""
        }
        <div className="justify-content-center">
          { status == "err" ? <Error location={{"state": {"message": requestMessage}}}/> : ""} 
          <div className="d-flex justify-content-center">
              ...
              <Form onSubmit={ scan } className="form-app">
                <Form.Group style={{position: "relative"}} className="d-flex justify-content-between">
                  ...
                  <Button variant={status == 'err' ? "danger": "primary"} className="form-on-button rounded-pill" type="submit">
                        {status != 'p' ? "Begin Scan": "Scanning..."}
                  </Button>
                </Form.Group>
                  ...
                  <Collapse in={cops1}>
                    <div className="py-4">
                      ...
                      <div className="d-flex px-2 justify-content-between">
                        ...
                        <Form.Control type="password" className="grey-control-scan" onChange={e => setPassword(e.target.value)} style={{width: "70%"}}/>
                      </div>
                    </div>
                  </Collapse>
                </Form.Group>
