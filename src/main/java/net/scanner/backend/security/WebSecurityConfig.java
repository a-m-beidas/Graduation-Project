...
import net.scanner.backend.config.AuthenticationEntryPointImpl;
import net.scanner.backend.controller.AccessDeniedHandlerImpl;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/", "/report", "/dashboard", "/scan", "/api/report", "/api/reports", "/login", "/register", "/logout", "/error").permitAll()
                // Webpack
                ...
                // Icons
                .antMatchers(HttpMethod.GET, "/favicon.ico", "/images/**").permitAll()
